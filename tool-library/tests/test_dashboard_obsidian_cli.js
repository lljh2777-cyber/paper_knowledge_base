...
const pluginRoot = path.join(projectRoot, "knowledge-base/.obsidian/plugins/agent-Dashboard");
...
assert.strictEqual(pkg.scripts["verify:obsidian"], "npm run verify && node scripts/obsidian-cli.mjs qa");
