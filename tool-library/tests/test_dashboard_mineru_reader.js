...
const esbuild = require(path.resolve(
	__dirname,
	"../../knowledge-base/.obsidian/plugins/agent-Dashboard/node_modules/esbuild",
));
...
const extractor = fs.readFileSync(
	path.join(projectRoot, "tool-library/scripts/run_mineru_extract.py"),
	"utf8",
);
...
assert.match(extractor, /visual-repair\.json/);
assert.match(extractor, /visual-candidates\.json/);
